...
{
    [UsedImplicitly]
    public class TwoInitialsFirstOptionalDotFirstLastPattern : IFullNamePattern
    {
        private static readonly string Pattern = $@"^{TwoInitialFirstOptionalDot}{Space}(?<last>\w+)$";
