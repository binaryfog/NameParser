...
{
    [UsedImplicitly]
    public class TwoInitialsSecondOptionalDotFirstLastPattern : IFullNamePattern
    {
        private static readonly string Pattern = $@"^{TwoInitialSecondOptionalDot}{Space}(?<last>\w+)$";
