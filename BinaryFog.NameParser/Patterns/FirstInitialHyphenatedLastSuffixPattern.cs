...
namespace BinaryFog.NameParser.Patterns {
    [UsedImplicitly]
    public class FirstInitialHyphenatedLastSuffixPattern : IFullNamePattern
    {
        private static readonly string Pattern = @"^" + First + Space + Initial + Space + LastHyphenated + Space + Suffix + @"$";
